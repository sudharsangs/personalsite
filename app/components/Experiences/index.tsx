    ...
    <div className="relative bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:rounded-lg mt-6">
      ...
      >
        <ul className="list-disc">
          <li>
            Developed a cutting-edge feature enabling real-time display of instant highlights generated by AI during live
            games using <strong>ReactJS</strong>, <strong>Emotion</strong> and <strong>RxJS</strong>
          </li>
          <li>
            Built an internal tool for visualization of AI-generated sports videos and clips, optimizing analysis and eval-
            uation procedures using <strong>ReactJS</strong>, <strong>VideoJS</strong>, <strong>Emotion</strong> and <strong>Firebase</strong>
          </li>
        </ul>
      </Experience>
