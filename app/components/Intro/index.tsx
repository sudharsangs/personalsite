...
export const Intro = () => {
  return (
    <div className="p-4 mt-4">
      <h1 className="sm:text-3xl text-2xl">Hi, I&apos;m Sudharsan</h1>
      <p className="mt-3 sm:text-xl text-md text-slate-600">Living in Bengaluru,India</p>
      <p className="mt-3 sm:text-xl text-md">
