      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
            <h3 className="text-lg font-semibold mb-2 text-amber-700">Atom Builder</h3>
            <p className="text-muted-foreground">Interactive tool for building atom models by adding protons, neutrons, and electrons while learning about atomic structure.</p>
          </div>
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
            <h3 className="text-lg font-semibold mb-2 text-amber-700">Element Explorer</h3>
            <p className="text-muted-foreground">Gamified periodic table where players discover element properties, uses, and interesting facts through exploration.</p>
          </div>
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
            <h3 className="text-lg font-semibold mb-2 text-amber-700">Reaction Lab</h3>
            <p className="text-muted-foreground">Virtual laboratory where students can conduct simple chemical reactions and observe molecular behavior in real-time.</p>
          </div>
        </div>
      </ProjectSection>
