...
const ExperienceProjectCard: React.FC<ExperienceProjectCardProps> = ({
  title,
  description,
  link,
  techStack,
  ...
  return (
    <div
      className={cn(
        "border border-border/50 rounded-lg p-4 shadow-sm bg-card/50 backdrop-blur-sm hover:shadow-md hover:border-primary/30 hover:shadow-primary/20 transition-all duration-300 rounded",
      )}
    >
