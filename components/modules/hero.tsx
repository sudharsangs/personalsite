                ...
                >
                    ...
                    >
                        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                            <Link href="/projects">
                                <Button className="bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary/80 text-primary-foreground shadow-xl hover:shadow-2xl transition-all duration-300 rounded-xl px-10 py-4 flex items-center gap-3 h-14 font-semibold text-base border border-primary/20 w-full">
                                    View My Work
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                            <Button
                                variant="outline"
                                className="bg-white/90 backdrop-blur-sm border-2 border-primary/40 text-primary hover:bg-gray-500 hover:text-white hover:border-gray-500 transition-all duration-300 rounded-xl px-10 py-4 h-14 font-semibold shadow-lg hover:shadow-xl text-base w-full"
